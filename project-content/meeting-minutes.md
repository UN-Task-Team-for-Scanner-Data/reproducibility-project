...
-   The team discussed and approved the email to request that the two main price statistics conferences reference our material:
    ...
    -   As some visitors to the site may still be confused, the team decided on a streamlined approach on how we could help. [Issue 64](https://github.com/UN-Task-Team-for-Scanner-Data/reproducibility-project/issues/64) to track the workfix .
