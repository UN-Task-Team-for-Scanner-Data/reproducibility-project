...
-   The team discussed what guidance we can provide to individuals that either develop a new method (in which case open data is best) or they are applying a tried method on their internal data (in which case use of proprietary data is absolutely fine).