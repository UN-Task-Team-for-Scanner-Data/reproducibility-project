...
The cornerstone of any reproducible project rests on five key ideas.
...
4.  Make the project **available for others**. In practice this leverages 1, 2, and 3 by putting the steps to recreate a research project on a service like **GitHub or GitLab**. Further to reproducibility benefits to the discipline, publicly sharing the code ensures that it can be reviewed by others alongside the method.[^2]
5.  If your research project includes methodological work, consider **evaluating it using publicly available data** whenever possible. There are [several open datasets commonly used within the discipline](https://un-task-team-for-scanner-data.github.io/price-stats-data-catalogue/) that can serve as benchmarks. Additionally, if feasible, you [**may want to publish your own datasets and contribute them to the catalogue**](/docs/catalogue/contributing.qmd) to support transparency and reproducibility.

[^2]: Peer review of code is a fantastic way to ensure that minor mistakes in the code did not impact broader guidance. The Reinhart and Rogoff analysis issue is a demonstrative example from only so recently. See [Steven Miller's technical blog summarizing the issue and how to reproduce the analysis](https://svmiller.com/blog/2020/04/reinhart-rogoff-ten-years-later-replication/) for a good overview, or check out [Herdon et al (2014)](https://doi.org/10.1093/cje/bet075) for the summary by those who caught the issue.
...
The next step towards making a project reproducible involves putting some structure on the project and following certain conventions. This makes it easier for someone to replicate your research, but it's also much easier to execute your project because it follows a proven recipe---no need to reinvent it.
...
-   [ ] Make input data available online when possible. Zenodo is a free-to-use option. You can also use existing open datasets if you can't or don't wish to go through the process of making your data available.
