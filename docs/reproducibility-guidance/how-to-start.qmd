...
4.  Make the project **available for others**. In practice this leverages 1, 2, and 3 by putting the steps to recreate a research project on a service like **GitHub or GitLab**. Further to reproducibility benefits to the discipline, publicly sharing the code ensures that it can be reviewed by others along side the method.[^2]
