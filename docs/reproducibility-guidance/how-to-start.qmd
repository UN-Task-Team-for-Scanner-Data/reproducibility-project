...
5.  If your research project trials a new method, if you can, **evaluate it with publicly available data**. There are a [few open datasets](https://un-task-team-for-scanner-data.github.io/price-stats-data-catalogue/) that are commonly used in the discipline.
...
-   [ ] The project is automated end-to-end, including the writeup of the paper published alongside the code. In essence, it is clear how each figure and table in the paper was generated.
