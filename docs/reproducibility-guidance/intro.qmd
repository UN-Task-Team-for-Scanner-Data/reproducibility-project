...
To make a research project reproducible, it is key to  observe that there is not one object that is produced (i.e., the paper), but 4. @fig-research-objects provides a visual that can help understand what each is intended to for and how to approach each for reproducibility.
