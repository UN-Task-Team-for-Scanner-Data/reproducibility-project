...
There are datasets that can be used for research but typically need to be purchased, hence limiting their use to many. This data is can be quite detailed and comprehensive in coverage, making it desirable to test specific properties. Two notable example proprietary datasets are [Nielsen](https://doi.org/10.1016/j.jacceco.2022.101495) and [IRI](https://doi.org/10.1287/mksc.1080.0450).
...
Making sure that sensitive information is not version controlled takes a little bit of prep and practice. However the benefit of all this far outweigh cost.
