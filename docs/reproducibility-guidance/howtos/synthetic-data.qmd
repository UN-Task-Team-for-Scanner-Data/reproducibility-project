...
- Tghe R package [synthsizer](https://CRAN.R-project.org/package=synthesizer) is a tool to generate synthesize different types of data.  single parameter allows balancing between high-quality synthetic data that represents correlations of the original data and lower quality but more privacy safe synthetic data without correlations. 
