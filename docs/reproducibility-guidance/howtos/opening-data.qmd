...
Using input data is one of the most immediate priorities to tackle when it comes to data management, however output of a research project may also be worth a second look. Outputs could be complex data files that may serve multiple functions, in which case their documentation and further preservation could be desirable.
